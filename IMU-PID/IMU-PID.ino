...
float VelocityMS = 1567.9963333424992990544387652732;
...
void en1_1() {
	...
	if (!digitalRead(8)) {
		PulseCounterRight++;
		VelocityRightWheelMS = VelocityMS / dt;
	}
	if (digitalRead(8))	{
		PulseCounterRight--;
		VelocityRightWheelMS = -VelocityMS / dt;
...
void en2_1() {
	...
	if (!digitalRead(23)) {
		PulseCounterLeft++;
		VelocityLeftWheelMS = VelocityMS / dt2;
	}
	if (digitalRead(23)) {
		PulseCounterLeft--;
		VelocityLeftWheelMS = -VelocityMS / dt2;
